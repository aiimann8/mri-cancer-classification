...
uploaded_file = st.file_uploader("Puja una imatge MRI en format JPG per diagnosticar si conté alguna tipologia (o no) de càncer cerebral (Glioma, Meningioma o Pituitari)", type="jpg")
